...
class AbecedarioResultsPage extends StatelessWidget {
  const AbecedarioResultsPage({Key? key, required this.quiz, required this.idTem, required this.Tem}) : super(key: key);
  final AbcQuiz quiz;
  final String idTem;
  final String Tem;
