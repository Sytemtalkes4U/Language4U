import 'dart:convert';
import 'package:ing/Quizz/Paginas/results_page.dart';
...
class QuizPage extends StatefulWidget {
  final String idTem;
  final String Tem;
  const QuizPage({super.key, required this.idTem, required this.Tem});

  @override
  State<QuizPage> createState() => _QuizPageState(this.idTem, this.Tem);
}
...
class _QuizPageState extends State<QuizPage> {
  ...
  int questionIndex = 0;
  int progressIndex = 0;
  Quiz quiz = Quiz(name: 'Quiz of Colors', questions: []);
