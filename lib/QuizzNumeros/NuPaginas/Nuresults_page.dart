...
class NumerosResultsPage extends StatelessWidget {
  const NumerosResultsPage({Key? key, required this.quiz, required this.idTem, required this.Tem}) : super(key: key);
  final NuQuiz quiz;
  final String idTem;
  final String Tem;
